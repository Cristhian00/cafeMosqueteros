...
public class SeguridadFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        try {
            ...
            if (requestURI.startsWith("/socio/")) {
                ...
                if (userManager != null) {
                    if (userManager.isAutenticado() && userManager.getRol().equals("socio")) {
            ...
            } else if (requestURI.startsWith("/noSocio/")) {
                //Obtenemos el objeto seguridadBean de la sesión actual
                SeguridadBean userManager = (SeguridadBean)
                        request.getSession().getAttribute("seguridadBean");

                if (userManager != null) {
                    if (userManager.isAutenticado() && userManager.getRol().equals("noSocio")) {
